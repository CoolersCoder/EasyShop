...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	<tr bgcolor="#efeae5">
		<td width="400px" colspan="5"><span style="font-weight: 900;">Order Generated</span></td>
	</tr>
	<tr align="center">
		<td width="10%">&nbsp;</td>
		<td width="50%">Bookname</td>
		<td>price</td>
		<td>Quantity</td>
		<td>subtotal</td>
	</tr>
	...
	<tr>
		<td colspan="6" align="right">
			<span>Total：</span><span class="price_t">&#36;<span id="total">${total}</span></span>
		</td>
	</tr>
	<tr>
		<td colspan="5" bgcolor="#efeae5"><span style="font-weight: 900">Customer Address</span></td>
	</tr>
	<tr>
		<td colspan="6">
			<input id="addr" type="text" name="address" value="40 Bristol Street, West Haven, CT ,06516"/>
		</td>
	</tr>
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			<a id="linkSubmit" href="javascript:$('#form1').submit();">Submit Order</a>
		</td>
	</tr>
</table>
</form>
