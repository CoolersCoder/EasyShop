...
<html>
  ...
  <body>
<div class="div1">
	<span class="span1">Order ready</span>
</div>
<div class="div2">
	...
	<span>Thank you for shopping in EasyShop </span>
	<a href="<c:url value='/OrderServlet?method=paymentPre&oid=${order.oid }'/>" id="linkPay">pay</a>
</div>
  </body>
</html>
