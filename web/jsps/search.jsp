...
<html>
  <head>
    <title>Search by bookName</title>
  ...
  <body>
    <form action="<c:url value='/BookServlet'/>" method="get" target="body" id="form1">
    	...
    	<span>
    		...
    		<a href="<c:url value='/jsps/gj.jsp'/>" style="font-size: 10pt; color: #404040;" target="body">Advance Search</a>
    	</span>
    </form>
